...
<template>
  <main class="flex-1 p-4 sm:p-6 lg:p-8">
    <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-6 lg:mb-8 gap-4 pt-10 lg:pt-0">
      <div>
        <h1 class="text-2xl sm:text-3xl font-bold">Manajemen Buku</h1>
        <p class="text-slate-600">Kelola koleksi perpustakaan</p>
      </div>
      <button
        @click="isAddBook = true"
        class="px-4 sm:px-6 py-3 bg-primary-600 rounded-xl font-semibold flex items-center gap-2 hover:opacity-90 text-white w-full sm:w-auto justify-center"
      >
    ...
    <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-6">
      ...
      <select
        ...
        class="w-full sm:w-auto px-4 py-3 bg-white border border-slate-200 rounded-xl focus:border-primary-500 focus:outline-none"
      >
  ...
  >
    ...
    >
      ...
      <form class="p-4 sm:p-6 space-y-4" @submit.prevent="handleAddBook">
  ...
  >
    ...
    >
      ...
      <form class="p-4 sm:p-6 space-y-4" @submit.prevent="handleEditBook">
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div class="col-span-2">
            <label class="block text-sm text-slate-600 mb-2">Cover Buku</label>
            <div class="flex items-center gap-4">
